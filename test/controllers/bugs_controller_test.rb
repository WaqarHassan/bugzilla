...
class BugsControllerTest < ActionController::TestCase
  ...
  test "should create bug" do
    assert_difference('Bug.count') do
      post :create, bug: { deadline: @bug.deadline, description: @bug.description, status: @bug.status, title: @bug.title, type: @bug.type }
    end
  ...
  test "should update bug" do
    patch :update, id: @bug, bug: { deadline: @bug.deadline, description: @bug.description, status: @bug.status, title: @bug.title, type: @bug.type }
    assert_redirected_to bug_path(assigns(:bug))
  end
